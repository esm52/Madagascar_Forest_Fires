...
lm.full <- lmer(log.ForestLossByArea ~ (1|Fokotany) + (1|Year) + Vanilla.Suit + VanillaProduction + VanillaExportPrice + RiceArea + RiceProduction + log.Pop2009 + Before.2005 + Before.2015 + ProtectedArea) 
